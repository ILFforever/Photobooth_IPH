...
const logger = createLogger('CameraContext');
...
export function CameraProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    const handleCameraConnected = (data: { type: string; camera_id: string; manufacturer: string; model: string; port: string; usb_version: string; serial_number?: string; firmware?: string; lens?: string }) => {
