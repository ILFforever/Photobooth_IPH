...
const SONY: CameraBrand = {
  ...
  modeMap: {
    ...
    'M': 'M',
    'Manual': 'M',
    // Sony expprogram choices — auto/scene modes map to P
    'Creative': 'P',
    'Action': 'P',
    'Portrait': 'P',
    'Intelligent Auto': 'P',
    'Superior Auto': 'P',
    'Intelligent Auto Flash Off': 'P',
    'Sports Action': 'P',
    'Macro': 'P',
    'Landscape': 'P',
    'Sunset': 'P',
    'Night Scene': 'P',
    'Hand-held Twilight': 'P',
    'Night Portrait': 'P',
    'Anti Motion Blur': 'P',
    'Picture Effect': 'P',
    '3D Sweep Panorama Shooting': 'P',
    'Sweep Panorama': 'P',
    'Tele-zoom Cont. Priority AE': 'P',
    'Tele-Zoom Cont. Priority AE 10': 'P',
    'Movie (Scene)': 'P',
    // Movie modes — preserve PASM intent
    'Movie (P)': 'P',
    'Movie (A)': 'A',
    'Movie (S)': 'S',
    'Movie (M)': 'M',
  ...
  quirks: {
    ...
    evSetting: 'exposurecompensation',
    meteringSetting: 'exposuremetermode',
    modeSetting: 'expprogram',
    meteringChoices: ['Multi', 'Center', 'Spot Standard', 'Spot Large', 'Entire Screen Avg.', 'Highlight'],
    focusModeChoices: ['Automatic', 'AF-A', 'AF-C', 'DMF', 'Manual'],
    whiteBalanceLabels: {
      'Automatic': 'Auto',
      'Daylight': 'Daylight',
      'Shade': 'Shade',
      'Cloudy': 'Cloudy',
      'Tungsten': 'Tungsten',
      'Fluorescent: Warm White': 'FL: Warm White',
      'Fluorescent: Cold White': 'FL: Cold White',
      'Fluorescent: Day White': 'FL: Day White',
      'Fluorescent: Daylight': 'FL: Daylight',
      'Flash': 'Flash',
      'Underwater: Auto': 'Underwater',
      'Choose Color Temperature': 'K',
      'Preset 1': 'Custom 1',
      'Preset 2': 'Custom 2',
      'Preset 3': 'Custom 3',
